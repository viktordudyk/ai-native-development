...
- **Ground every claim in defensible numbers:** 2-5x implementation speed for well-specified tasks, 50% spec time, $10-200/month tooling cost range (pro to enterprise), 2-4 week break-even. Detailed sources and evidence are in the [Fact-Check Report](03-fact-check-deep-research.md)
